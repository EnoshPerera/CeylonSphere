...
//             _location = userData.data()?['location'] ?? "Delkanda, Sri Lanka";
...
//     try {
//       await _auth.signOut();
//       // Navigate to a new route that shows the welcome popup
//       Navigator.pushReplacement(
//         context,
//         MaterialPageRoute(
//           builder: (context) => const WelcomePopupPage(), // Navigate to a new page that shows the popup
//         ),
//       );
//     } catch (e) {
...
//                           final user = _auth.currentUser;
//                           if (user != null) {
//                             _firestore.collection('user_preferences').doc(user.uid).set({
...
// // Create a new widget to display the welcome popup
// class WelcomePopupPage extends StatelessWidget {
//   const WelcomePopupPage({super.key});

//   @override
//   Widget build(BuildContext context) {
//     // Call the WelcomePopup.show method in the build method
//     WidgetsBinding.instance.addPostFrameCallback((_) {
//       WelcomePopup.show(context);
//     });

//     // Return a simple scaffold or empty container
//     return Scaffold(
//       body: Container(), // You can customize this if needed
//     );
//   }
// }
