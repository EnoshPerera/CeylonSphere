...
import 'souvenir_item_page2.dart';

class SouvenirListPage2 extends StatefulWidget {
  const SouvenirListPage2({super.key});

  @override
  State<SouvenirListPage2> createState() => _SouvenirListPageState();
}

class _SouvenirListPageState extends State<SouvenirListPage2> {
